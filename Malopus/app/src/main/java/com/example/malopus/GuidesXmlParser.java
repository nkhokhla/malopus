...
//    }
    ...
    private Item readEntry(XmlPullParser parser) throws XmlPullParserException, IOException, ParseException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if (name.equals("title")) {
                ...
                description = fromHtml(description, HtmlCompat.FROM_HTML_MODE_LEGACY).toString();
                Log.d("readEntry", description);
            } else if (name.equals("link")) {
                link = readLink(parser);
                Log.d("readEntry", link);
            }else if (name.equals("encoded")) {
                System.arraycopy(readFigure(parser), 0, descriptionArray, 0, 2);
        ...
        return new Item(title, description, link, imageLink, date);
    }
    ...
    private String[] readFigure(XmlPullParser parser) throws IOException, XmlPullParserException {
